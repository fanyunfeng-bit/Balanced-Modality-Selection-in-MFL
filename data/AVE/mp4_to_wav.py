...
all_videos = r'D:\DATASETS\AVE_Dataset\AVE_Dataset\Annotations.txt'
all_audio_dir = r'D:\DATASETS\AVE_Dataset\AVE_Dataset\Audios'
...
for i, item in enumerate(files[1:]):
    if i % 500 == 0:
        ...
        print('*******************************************')
    item = item.split('&')
    mp4_filename = os.path.join(r'D:\DATASETS\AVE_Dataset\AVE_Dataset\AVE', item[1] + '.mp4')
